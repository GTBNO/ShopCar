//
//  MutibleSelectTableViewController.m
//  ShopCar
//
...
@interface MutibleSelectTableViewController ()
...
@implementation MutibleSelectTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.singeleSelectBtn.selected = _flag[indexPath.row];
    
    __weak __typeof(cell)weakCell = cell;
    cell.singleBlock = ^(){
        
        _flag[indexPath.row] = !_flag[indexPath.row];
        weakCell.singeleSelectBtn.selected = _flag[indexPath.row];
    };
    return cell;
}
